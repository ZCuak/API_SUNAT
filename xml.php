...
// Cálculos iniciales
$empresa['modo'] = 0;
$venta['total_a_pagar']     = $detalle[0]['cantidad'] * $detalle[0]['precio'];
$venta['total_gravada']     = $venta['total_a_pagar'] / 1.18;
$venta['total_igv']         = $venta['total_a_pagar'] - $venta['total_gravada'];
...
function desarrollo_xml($empresa, $cliente, $venta, $detalles){
    ...
    $linea_inicio       = '<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" '
    ...
    $linea_fin          = 'Invoice';
    $InvoiceTypeCode    = '<cbc:InvoiceTypeCode listID="0101" listAgencyName="PE:SUNAT" listName="Tipo de Documento" '
                        .'listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo01" name="Tipo de Operacion" '
                        .'listSchemeURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo51">' 
                        . $venta['tipo_documento_codigo'] . '</cbc:InvoiceTypeCode>';
    ...
    $xml .= $InvoiceTypeCode
            ...
            .'listAgencyName="United Nations Economic Commission for Europe">'. $codigo_moneda .'</cbc:DocumentCurrencyCode>';
    ...
    $xml .=  '<cac:TaxTotal>
                <cbc:TaxAmount currencyID="'. $codigo_moneda .'">'. number_format($total_igv, 2, '.', '') .'</cbc:TaxAmount>';
        ...
        $xml .= '<cac:InvoiceLine>
                ...
                <cac:PricingReference>
                    <cac:AlternativeConditionPrice>
                        ...
                        .'listURI="urn:pe:gob:sunat:cpe:see:gem:catalogos:catalogo16">' . $PriceTypeCode . '</cbc:PriceTypeCode>
                    </cac:AlternativeConditionPrice>
                </cac:PricingReference>';        
